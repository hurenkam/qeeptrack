...
TabOptionsPage {
    ...
    background: Rectangle {
        ...
        ToolButton {
            ...
            source: "backc.png";
            onClicked: {
                console.log("SpeedometerOptionsPage.onCancel")
                root.cancel();
            }
        }
        ...
        ToolButton {
            ...
            onClicked: {
                console.log("SpeedometerOptionsPage.onConfirm")
                optionsChanged()
                pageStack.pop()
            }
    ...
    onPushed: {
        console.log("SpeedometerOptionsPage.onPushed")
    }
    onPopped: {
        console.log("SpeedometerOptionsPage.onPopped")
    }
}
